...
strains. [^1] In particular, the studies **GM05296** and
...
For plotting the data we have to generate an `r Biocpkg("DNAcopy")` object out of the
...
invisible(segPlot(gr, res, plot.type="s"))
```
:::
